...
function Navbar() {
	...
	return (
		<>
			{!isMobile ? (
				<nav className="w-[75%] rounded-2xl bg-[#D4FCFF]/30 m-auto items-center font-me justify-between p-3 px-4 text-[#410041] font-bold font-leagueSpartan fixed z-50 top-4 left-1/2 -translate-x-1/2 backdrop-blur shadow-md shadow-black/20 hidden md:flex">
					<Icon />
					<div className="">
						<Links />
					</div>
				...
				<nav className="">
					...
					<div
						className="text-[#410041] font-lexend bg-[#c9a0c9]/80 inset-0 fixed z-50 backdrop-blur-sm flex items-center justify-center invisible opacity-0"
						ref={mobNav}
					>
						<Links />
					</div>
