...
function Section1() {
	return (
		<div className="flex lg:flex-row flex-col bg-[#FBB4B8] rounded-b-3xl justify-evenly md:justify-around items-center relative h-[65dvh] md:h-[95dvh] w-full">
			<div className="lg:w-[40%] text-center lg:text-left mt-20 lg:mt-0 p-1" data-scroll data-scroll-speed="-.05">
			...
			<div className="lg:w-[50%]" data-scroll data-scroll-speed=".05"
				>
				<Image
					src={"/therapist.png"}
					alt="therapist"
